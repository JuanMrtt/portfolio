export const data = {
    navigation: [
        { pag: 'aboutMe', text: 'Sobre mí' },
        { pag: 'experience', text: 'Experiencia profesional' },
        { pag: 'projects', text: 'Proyectos personales' },
        { pag: 'contact', text: 'Contacto' },
    ],
    introduction: {
        preTitle: 'Hola, mi nombre es ',
        title: 'Juan Antonio Martin',
        paragraph_1:
            'Soy desarrollador fullstack Javascript viviendo en Madrid',
    },
    aboutMe: {
        title: 'Sobre mí',
        paragraph_1:
            'Hola, soy Juan Antonio y soy desarrollador fullstack Javascript especialista en el stack MERN & React Native',
        paragraph_2:
            'Apasionado por la tecnología desde que era un enano, después de obtener el grado en Administración de Empresas, vivir en Reino Unido y trabajar como contable e IT-Recruiter finalmente me decidí a estudiar en Enero 2020 aquello que me apasionaba desde pequeño.',
        paragraph_3:
            'Por ello comencé mi experiencia en éste sector disfrutando de la experiencia IronHack.',
        paragraph_4:
            'Trabajador, responsable, trabajador en equipo y resolutivo.Con muchas ganas de aprender y de desarrollarme profesionalmente!',
    },
    experience: {
    ...
    projects: {
        ...
        projects: [
            ...
            },
            {
                ...
                type: 'Personal Project',
                description:
                    'Aplicación para gestionar la educación de los perros, con lecciones paso a paso y videos explicativos.',
                technologies: [
                    'ReactJS',
                    'Redux',
                    'NodeJS',
            ...
            },
            {
                ...
                type: 'Personal Project',
                description:
                    'Segundo proyecto en pareja en IronHack. Una aplicación de noticias usando una API externa con las tecnologías de NodeJS, ExpressJS y Handlebars.',
            ...
            },
            {
                ...
                type: 'Personal Project',
                description:
                    'Primer proyecto en IronHack. Videojuego multijugador utilizando Canvas y Vanilla JS.',
    ...
    contact: {
        title: 'Contacto',
        paragraph_1:
            'Mi email siempre esta abierto para nuevos contactos, cualquier consejo para cómo mejorar y para cualquier oportunidad laboral.',
